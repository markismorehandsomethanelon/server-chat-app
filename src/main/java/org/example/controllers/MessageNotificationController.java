...
public class MessageNotificationController {
    ...
    public ResponseEntity<ResponseDTO<List<MessageNotificationDTO>>> findUnreadMessagesByUserIdAndConversationId(@PathVariable Long conversationId, @PathVariable Long userId) {
